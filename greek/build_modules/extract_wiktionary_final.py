...
def extract_wiktionary_data():
    ...
    for lemma, forms in lemma_to_forms.items():
        ...
        # Look for definition
        definition = ""
        # Track which dictionary the definition actually came from. Downstream
        # (combine_dictionaries_to_lemma_map / interlinear gloss extraction)
        # must parse each source with its own format-specific extractor; a
        # Cunliffe-formatted body tagged 'wiktionary' produces broken glosses
        # (see ἐφίστημι → "(5)(11)]. 3 sing. aor. 124, 496, 201...").
