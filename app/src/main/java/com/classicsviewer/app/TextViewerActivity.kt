...
class TextViewerActivity : BaseActivity() {
    ...
    private fun openDictionary(word: String) {
        lifecycleScope.launch {
            ...
            if (language.equals("latin", ignoreCase = true)) {
            ...
            android.util.Log.d("TextViewerActivity", "openDictionary called for word='$word', language='$language'")
            
            android.util.Log.d("TextViewerActivity", "Going to dictionary")
