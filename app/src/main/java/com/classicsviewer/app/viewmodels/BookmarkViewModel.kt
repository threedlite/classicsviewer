...
class BookmarkViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun checkBookmarkStatus(bookId: String, lineNumber: Int, sequenceNumber: Int) {
        viewModelScope.launch {
            _isBookmarked.value = repository.isBookmarked(bookId, lineNumber, sequenceNumber)
        }
    }
    ...
    fun toggleBookmark(
        ...
        viewModelScope.launch {
            val wasAdded = repository.toggleBookmark(
                workId, bookId, lineNumber, sequenceNumber, authorName, workTitle, bookLabel, lineText, note
            )
    ...
    fun deleteBookmarkByLocation(bookId: String, lineNumber: Int, sequenceNumber: Int) {
        viewModelScope.launch {
            repository.deleteBookmarkByLocation(bookId, lineNumber, sequenceNumber)
    ...
    suspend fun getBookmark(bookId: String, lineNumber: Int, sequenceNumber: Int): BookmarkEntity? {
        return repository.getBookmark(bookId, lineNumber, sequenceNumber)
    }
