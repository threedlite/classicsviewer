...
class BookmarkRepository(context: Context) {
    ...
    suspend fun isBookmarked(bookId: String, lineNumber: Int, sequenceNumber: Int): Boolean = 
        bookmarkDao.isBookmarked(bookId, lineNumber, sequenceNumber)
    ...
    suspend fun toggleBookmark(
        ...
        val existingBookmark = bookmarkDao.getBookmark(bookId, lineNumber, sequenceNumber)
    ...
    suspend fun deleteBookmarkByLocation(bookId: String, lineNumber: Int, sequenceNumber: Int) {
        bookmarkDao.deleteBookmarkByLocation(bookId, lineNumber, sequenceNumber)
    }
    ...
    suspend fun getBookmark(bookId: String, lineNumber: Int, sequenceNumber: Int): BookmarkEntity? = 
        bookmarkDao.getBookmark(bookId, lineNumber, sequenceNumber)
