...
class OccurrenceAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val isGreek = occurrence.language.equals("greek", ignoreCase = true)
        if (isGreek && PreferencesManager.getUseSinaiticusFont(holder.itemView.context) && sinaiticusTypeface != null) {
