...
interface LemmaMapDao {
    ...
    @Query("SELECT * FROM lemma_map WHERE word_normalized = :wordNormalized ORDER BY confidence DESC")
    suspend fun getAllLemmaMappingsForWord(wordNormalized: String): List<LemmaMapEntity>
