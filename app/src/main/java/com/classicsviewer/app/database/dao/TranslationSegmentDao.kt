...
interface TranslationSegmentDao {
    ...
    @Query("""
        ...
        AND (
            -- Original range-based lookup - include segments that overlap or are adjacent
    ...
    @Query("SELECT * FROM translation_segments WHERE book_id = :bookId ORDER BY start_line, sequence_number")
