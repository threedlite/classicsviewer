...
public final class ItemLanguageBinding implements ViewBinding {
  ...
  private ItemLanguageBinding(@NonNull MaterialCardView rootView, @NonNull TextView languageName) {
  ...
  public static ItemLanguageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemLanguageBinding((MaterialCardView) rootView, languageName);
    }
